...
function App(Props) {
  ...
  return React.createElement(Wrapper$ReasonCarousel.component, {
              isOpen: state[/* isOpen */0],
              ...
              children: null
            }, React.createElement(Header$ReasonCarousel.component, {
                  children: null
                      ...
                      onClick: (function ($$event) {
                        ...
                        })), React.createElement("h1", undefined, currentRoute[/* title */1])), React.createElement(Nav$ReasonCarousel.component, {
                  isOpen: state[/* isOpen */0],
                  onClick: (function ($$event) {
                      $$event.stopPropagation();
                      return /* () */0;
