...
import * as Link$ReasonCarousel from "./router/Link.bs.js";
...
import * as Redirect$ReasonCarousel from "./router/Redirect.bs.js";
...
function App(Props) {
  ...
  if (match) {
    switch (match.hd) {
      case "page1" :
          title = match.tl ? "404" : "Page 1";
          break;
      case "page2" :
          title = match.tl ? "404" : "Page 2";
          break;
      case "page3" :
          title = match.tl ? "404" : "Page 3";
          break;
      default:
        title = "404";
    }
  ...
  if (match$5) {
    switch (match$5.hd) {
      case "page1" :
          if (match$5.tl) {
            ...
            tmp$1 = React.createElement(Page1$ReasonCarousel.make, {});
          }
          break;
      case "page2" :
          if (match$5.tl) {
            ...
            tmp$1 = React.createElement(Page2$ReasonCarousel.make, {});
          }
          break;
      case "page3" :
          if (match$5.tl) {
            ...
            tmp$1 = React.createElement(Page3$ReasonCarousel.make, {});
          }
          break;
      default:
        exit$1 = 1;
    ...
    tmp$1 = React.createElement(Home$ReasonCarousel.make, {});
  }
  if (exit$1 === 1) {
    tmp$1 = React.createElement(Redirect$ReasonCarousel.make, {
          to_: "/"
        });
  }
              ...
              children: null
                  ...
                  children: null
                      ...
                      onClick: (function ($$event) {
                        ...
                        })), React.createElement("h1", undefined, title)), React.createElement(Nav$ReasonCarousel.sc, {
                  isOpen: state.isOpen,
                  onClick: (function ($$event) {
                      $$event.stopPropagation();
                  ...
                  children: null
                          ...
                          onClick: (function (_event) {
                            ...
                            }), title)), React.createElement("label", undefined, "home"), React.createElement("ul", undefined, React.createElement("li", undefined, React.createElement(Link$ReasonCarousel.make, {
                              href: "/",
                              children: "Home",
                              isNavLink: true
                            }))), React.createElement("label", undefined, "pages"), React.createElement("ul", undefined, React.createElement("li", undefined, React.createElement(Link$ReasonCarousel.make, {
                              href: "/page1",
                              children: "Page1",
                              isNavLink: true
                            })), React.createElement("li", undefined, React.createElement(Link$ReasonCarousel.make, {
                              href: "/page2",
                              children: "Page2",
                              isNavLink: true
                            })), React.createElement("li", undefined, React.createElement(Link$ReasonCarousel.make, {
