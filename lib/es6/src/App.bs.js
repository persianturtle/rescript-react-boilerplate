          ...
          /* reducer */(function (action, state) {
              switch (action.tag | 0) {
                ...
                case 3 : 
                    ...
                    if (velocity < -0.3) {
                      var init$3 = state[/* nav */1];
                      return /* Update */Block.__(0, [/* record */[
                                  /* user */state[/* user */0],
                                  /* nav : record */[
                                    /* isOpen */false,
                                    /* isSwiping */init$3[/* isSwiping */1],
                                    /* position */init$3[/* position */2],
                                    /* width */init$3[/* width */3]
                                  ]
                                ]]);
                    } else if (action[0] < state[/* nav */1][/* width */3][0] / 2.0) {
                      var init$4 = state[/* nav */1];
                      return /* Update */Block.__(0, [/* record */[
                                  /* user */state[/* user */0],
                                  /* nav : record */[
                                    /* isOpen */false,
                                    /* isSwiping */init$4[/* isSwiping */1],
                                    /* position */init$4[/* position */2],
                                    /* width */init$4[/* width */3]
                                  ]
                                ]]);
                    } else {
